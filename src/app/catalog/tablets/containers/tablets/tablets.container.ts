...
@Component({
  selector: 'tablets-container',
  templateUrl: './tablets.container.html',
  styleUrls: ['./tablets.container.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TabletsContainer implements OnInit, OnDestroy {
  ...
  public getData(params: IQueryParams): void {
    this._dataService.getTablets(params);
  }
